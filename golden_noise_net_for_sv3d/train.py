...
parser.add_argument('--train_root_dir', default="", type=str)
...
for i in range(args.epoch):
    ...
    for data in train_dataloder:
                    ...
                    gt_latents = gt_latents.squeeze(1)/700
                    org_latents = org_latents.squeeze(1)/700
    ...
    with torch.no_grad():
        ...
        print(f"epoch_{i+1}对应test_loss={test_loss}")
        print(f"inf={inf}")
        print(f"nan={nan}")
        if i == 0:
