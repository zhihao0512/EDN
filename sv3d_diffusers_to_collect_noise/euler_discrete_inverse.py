...
class EulerDiscreteInverseSchedulerOutput(BaseOutput):
    """
...
class EulerDiscreteInverseScheduler(SchedulerMixin, ConfigMixin):
    ...
    def scale_model_input(self, sample: torch.Tensor, timestep: Union[float, torch.Tensor]) -> torch.Tensor:
        ...
        sigma = self.sigmas[16-self.step_index]
    ...
    def step(
    ...
    ) -> Union[EulerDiscreteInverseSchedulerOutput, Tuple]:
        """
        ...
        sigma = self.sigmas[15-self.step_index]

        sigma_t_1 = self.sigmas[16-self.step_index]
        ...
        dt = self.sigmas[16-self.step_index] - sigma_hat

        # prev_sample = sample + derivative * dt
        prev_sample = y * (x * sample - x**0.5 *dt * model_output)
        ...
        return EulerDiscreteInverseSchedulerOutput(prev_sample=prev_sample)
