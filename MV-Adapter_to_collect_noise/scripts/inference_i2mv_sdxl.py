...
def run_pipeline(
    ...
    reference_latents,org_latents,gt_latents = pipe(
        text,
        height=height,
        width=width,
    ...
    return reference_latents,org_latents,gt_latents
...
if __name__ == "__main__":
    ...
    for folder_name in os.listdir(args.image_folder):
        ...
        if os.path.exists(output_folder_path) and os.path.isdir(output_folder_path):
            ...
            reference_latents,org_latents,gt_latents = run_pipeline(
                pipe,
                num_views=args.num_views,
                text="",
                image=image_path,
            ...
            org_latents_path = os.path.join(output_folder_path, 'org_latents.pt')
            gt_latents_path = os.path.join(output_folder_path, 'gt_latents.pt')
            reference_latents_path = os.path.join(output_folder_path, 'reference_latents.pt')
            torch.save(org_latents, org_latents_path)
            torch.save(gt_latents, gt_latents_path)
            torch.save(reference_latents, reference_latents_path)
